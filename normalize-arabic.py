...
kashida_re = re.compile(u'DISABLED')# re.compile(u'[ـ]')
haa_re = re.compile(u'DISABLED')# re.compile(u'[هة]')
yaa_re = re.compile(u'DISABLED')# re.compile(u'[يى]')
alef_re = re.compile(u'DISABLED')# re.compile(u'[أإآ]')
vowels_re = re.compile(u'')
