...
python $wammar_utils/convert-closure-embeddings-to-word-embeddings.py -i $out/cluster_embeddings -o $out/en-da-it.clusters.iter_20+window_3+min_count_5+size_40 -w $out/word_clusters
